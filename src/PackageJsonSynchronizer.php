 ...
 *
 * @author Titouan Galopin <https://github.com/tgalopin>
 *
 * @internal
 */
class PackageJsonSynchronizer
{
    ...
    public function synchronize(array $packagesNames): void
    {
    ...
    private function removePackageJsonLinks(array $packageJson): void
    {
    ...
    private function addPackageJsonLink(string $phpPackage): void
    {
        ...
        $content = json_decode($manipulator->getContents(), true, 512, JSON_THROW_ON_ERROR);
    ...
    private function registerWebpackResources(array $phpPackages): void
    {
    ...
    private function resolveAssetsDir(string $phpPackage): ?string
    {
